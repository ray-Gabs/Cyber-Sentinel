...
export default function CorrelationPage() {
  ...
  return (
    ...
    <ConfirmModal
      ...
      message={`Delete all ${correlations.length} correlation run${correlations.length !== 1 ? "s" : ""}?`}
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr style={{ backgroundColor: "var(--bg-2)", borderBottom: "1px solid var(--border)" }}>
                              ...
                              <th className="px-4 py-2.5 text-left">
                                <div className="flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wide" style={{ color: "var(--text-3)" }}>
                                  Match Type <InfoTooltip text="Why the engine linked these two — hover each type badge for details." />
                                </div>
                              </th>
                              <th className="px-4 py-2.5 text-right">
                                <div className="flex items-center justify-end gap-1.5 text-[11px] font-medium uppercase tracking-wide" style={{ color: "var(--text-3)" }}>
                                  Confidence <InfoTooltip text="How certain the engine is about this correlation — 80%+ = high, 50-79% = medium, &lt;50% = low." />
                                </div>
                              </th>
                            </tr>
                          </thead>
                            ...
                            {corr.links.map((link, i) => {
                              ...
                              return (
                                <tr
                                  ...
                                  style={{
                                    borderBottom: i < corr.links.length - 1 ? "1px solid var(--border)" : undefined,
                                  }}
                                >
