...
import {
  ...
  Lock, Mail, User, Check, X, CheckCircle2,
} from "lucide-react";
...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(0,212,255,0.07) 0%, transparent 65%)" }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 90% 90% at 50% 50%, transparent 35%, rgba(8,12,16,0.82) 100%)" }}
      />
