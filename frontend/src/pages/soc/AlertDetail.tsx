...
export default function AlertDetail() {
  ...
  const handleTriggerPlaybook = async () => {
    ...
    try {
      ...
      setSelectedPlaybook("");
    } catch { /* backend returns 404 if no match */ }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {alert.threat_intel && (
        <div className="card">
          ...
          <div style={{ padding: "0 var(--pad-card) var(--pad-card)", display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {alert.iocs && Object.values(alert.iocs).some((v) => v && v.length > 0) && (
        <div className="card">
          ...
          <div style={{ padding: "0 var(--pad-card) var(--pad-card)", display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div className="card">
        ...
        <div style={{ padding: "0 var(--pad-card) var(--pad-card)", display: "flex", flexDirection: "column", gap: 12, maxWidth: 420 }}>
